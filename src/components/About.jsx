...
export const About = () => {
  ...
  const handleClick = () => {
    window.open(
      "https://drive.google.com/file/d/1Hx2pNdw5twiyLlxXlyKzRQRev3-xwjSI/view",
      "_blank"
    );
  };
      ...
      <Box>
        ...
        >
          <Box maxW={"478px"} color={"brand.400"}>
            ...
            >
              Full Stack Web Developer with a rapid learning ability. Proficient
              in Generative AI, JavaScript, Python and adept at crafting diverse
              projects for user and admin interfaces. Committed to continuous
              learning and innovation, with 1200+ hours of coding experience,
              450+ hours dedicated to data structures and algorithms, and 100+
              hours invested in soft skill development.
            </Text>
            <Flex
              mt={"1rem"}
              alignItems={"center"}
