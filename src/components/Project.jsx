...
import cotds_1 from "../image/1_cotds.PNG";
import cotds_2 from "../image/2_cotds.PNG";
import cotds_3 from "../image/3_cotds.PNG";
import cotds_4 from "../image/4_cotds.PNG";
import bloggtp_1 from "../image/1_blogGTP.png";
import bloggtp_2 from "../image/2_blogGTP.PNG";
import bloggtp_3 from "../image/3_blogGTP.PNG";
import bloggtp_4 from "../image/4_blogGTP.PNG";
import mernerp_1 from "../image/1_mernerp.PNG";
import mernerp_2 from "../image/2_mernerp.PNG";
import mernerp_3 from "../image/3_mernerp.PNG";
import mernerp_4 from "../image/4_mernerp.PNG";
...
export const Project = () => {
  const arrProject = [
    {
      ...
      name: "Cotds",
      description:
        "Cotds India Private Limited offers control valve software solutions and consulting services in Valve Design & Application Engineering.",

      image: [cotds_1, cotds_2, cotds_3, cotds_4],
      tech: [
        "Python",
        "Flask",
        "Next.js",
    ...
    {
      id: 7,
      name: "BlogGTP Automation",
      description:
        "Automated the end-to-end process of generating blogs using ChatGPT by reading data from Excel with Python. Converted content into HTML drafts and deployed them to the server using PyAutoGUI for full hands-free execution.",

      image: [bloggtp_1, bloggtp_2, bloggtp_3, bloggtp_4],
      tech: ["Python", "PyAutoGUI", "openpyxl", "php"],
      github: "",
      demo: "",
    },

    {
      ...
      name: "ERP Software",
      description:
        "Developed a custom ERP system for an electric tube manufacturing company with multi-user roles including customer, manager, supplier, admin, and superadmin. Streamlined the entire manufacturing workflow across modules like raw material, production, packaging, billing, dispatch, and replacements.",

      image: [mernerp_1, mernerp_2, mernerp_3, mernerp_4],
      tech: [
        "React.js",
        "Node.js",
        "Express.js",
  ...
  return (
    <Box id="projects" mt={"6rem"}>
      <Box mb={"2rem"}>
        <Heading color={"brand.400"}>Projects</Heading>
      </Box>
